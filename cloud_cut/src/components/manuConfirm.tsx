...
export default function ManuConfirm({
    ...
    return (
        ...
        >
            <div
                className={`bg-white dark:bg-gray-800 p-6 rounded-xl shadow-2xl w-full border border-gray-200 dark:border-gray-700 transform transition-all duration-300 scale-100 relative w-1/3`}
